...
#define CUDA_ROUTINE_HANDLER(name) Result * handle##name(CudaRtHandler * pThis, Buffer * input_buffer)	//test04 Sandy
...
CUDA_ROUTINE_HANDLER(RegisterFatBinary);	//Sandy test04
CUDA_ROUTINE_HANDLER(UnregisterFatBinary);	//Sandy test04
